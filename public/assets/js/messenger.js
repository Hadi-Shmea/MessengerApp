...
const addMessage = function (message , c='') {
    $("#chat-body").append(`  <div class="message ${c}">
                                        ...
                                        <div class="message-inner">
                                            ...
                                            <div class="message-footer">
                                                <span class="extra-small text-muted">${moment(message.created_at).fromNow()}</span>
                                            </div>
                                        </div>
                                    </div>`);
};
const getConversations =function(){
    $.get('/api/conversation',function(response){
        for( i in response){
...
// event delegation for chat list which is the parent of the chat card (data-messages)and apply the event on the son
$('#chat-list').on('click','[data-messages]',function(e){
    ...
    $.get(`api/conversations/${id}/messages`,function(response){ 
        ...
        for( i in response.messages.data){
            ...
            let c = message.user_id==userId?'message-out':'';
            // console.log(message);
